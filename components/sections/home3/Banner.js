        ...
        <Swiper {...swiperOptions} className="banner-carousel">
          <SwiperSlide className="slide-item">
            <div
              ...
              style={{
                backgroundImage: "url(assets/images/banner/banner-07.png)",
              }}
            >
              <div className="auto_container">
                <div className="content-inner">
                  <div className="content__box text-center">
                    ...
                    <h1>
                      Best Designing Service <br /> &amp; Consulting
                    </h1>
          ...
          <SwiperSlide className="slide-item">
            <div
              className="slide__item__content"
              style={{
                backgroundImage: "url(assets/images/banner/banner-08.png)",
              }}
            >
              <div className="auto_container">
                <div className="content-inner">
          ...
          <SwiperSlide className="slide-item">
            <div
              className="slide__item__content"
              style={{
                backgroundImage: "url(assets/images/banner/banner-09.png)",
              }}
            >
              <div className="auto_container">
                <div className="content-inner">
