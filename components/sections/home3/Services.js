          ...
          <div className="auto_container">
            <div className="title text-center">
              ...
              <div className="main__title">
                <h2>
                  We’re Prodviding Quality <br /> Designing Services
                </h2>
              </div>
            </div>
                    ...
                    >
                      <div className="inner__tab">
                        <div
                          ...
                          style={{
                            backgroundImage:
                              "url(assets/images/shape/shape-40.png)",
                          }}
                        />
                        <div
                          ...
                          style={{
                            backgroundImage:
                              "url(assets/images/shape/shape-41.png)",
                          }}
                        />
                        <div className="tab__content__three">
                          ...
                          <div className="tab__content__text">
                            <span className="tab___all"> Designing Layer </span>
                          </div>
                        </div>
                      </div>
                    </li>
                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-6 col-md-12 ps-xl-4">
                          <div className="tab__right__content">
                            <h4>Designing Layer</h4>
                            <div className="tab__text">
                              <p>
                                Lorem ipsum dolor sit amet, consectetur
                                adipiscing elit. Adipiscing integer ultrices
                                suspendisse varius etiam est. Est, felis, tempus
                                nec vitae orci sodales Metus, velit nec at diam
                                in sed. Massa dui ipsum ornare sagittis dolor
                                sagittis amet odio est. Sit semper et velit
                                fusce.
                              </p>
                            </div>
