    ...
    <>
      ...
      <section className="about__section p_relative">
        <div className="anim-icon">
          ...
          <div
            className="icon icon-02 wow slideInRight animated"
            data-wow-delay="100ms"
            data-wow-duration="1500ms"
            style={{ backgroundImage: "url(assets/images/shape/shape-12.png)" }}
          ></div>
          <div
            className="icon icon-03 wow slideInLeft animated"
            data-wow-delay="100ms"
            data-wow-duration="1500ms"
                        ...
                        <div className="inner__box">
                          <div className="image__box">
                            <figure className="image">
                              <img
                                src="assets/images/resource/about-01.png"
                                alt=""
                              />
                            </figure>
                          </div>
                      ...
                      <div className="about__image__block">
                        <div className="inner__box">
                          <div className="image__box">
                            <figure className="image">
                              <img
                                src="assets/images/resource/about-02.png"
                                alt=""
                              />
                            </figure>
                          </div>
                      ...
                      <div className="about__image__block  pt-20">
                        <div className="inner__box">
                          <div className="image__box">
                            <figure className="image">
                              <img
                                src="assets/images/resource/about-03.png"
                                alt=""
                              />
                            </figure>
                          </div>
