                  ...
                  <div className="news__block__one">
                    ...
                    <div className="lower__content two">
                      <div
                        ...
                        style={{
                          backgroundImage:
                            "url(assets/images/shape/shape-05.png)",
                        }}
                      >
                        <Link href="#">
                          11 <span>April</span>{" "}
                      ...
                      <div className="author__info">
                        <ul>
                          <li>
                            <Link href="#">
                              <span className="icon-icon-22"></span>by Admin
                            </Link>{" "}
                      ...
                      <div className="news__details__text">
                        <p>
                          ...
                          mattis sit massa lacus morbi feugiat aliquamsagittis
                        ...
                        <p className="pt-30">
                          ...
                          accumsan ullamcorper nunc scelerisque turpis facilisis
                          pretium ut facilisis pharetra, ultrices. Duis
                          imperdiet habitant arcu quis. Nunc euismod odio cursus
                          in diam eget tincidunt mauris.
                        </p>
                      </div>
                    </div>
                    <div className="authore__des">
                      <p>
                        ...
                        amet sit purus elit tempor dui consequat nibh elit urna
                        interdum.
                      </p>
                    ...
                    <div className="news__details__text">
                      <p>
                        Cursus ornare non non massa elit rutrum. eros proin nibh
                        neque interdum accumsan, neque vitae. Tortor etiam sed
                        suspendisse faucibus volutpat mattis tortor nec. Orc
                        velit posuere turpis amet. Lectus lacus lectus habitase
                        amet quam libero lorem. Volutpat maecenas viverra
                        consequat condimentum diam donec aliquet. Natoque quam
                        vitae leo risus. Eget neque proin in dolor cursus
                        bibendum urna dictum. Aliquam gravida et proin maecenas
                        ...
                        <div className="col-xl-6 col-md-6">
                          <div className="inner__box">
                            <div className="image__box">
                              <figure className="image">
                                <img
                                  src="assets/images/news/news-10.png"
                                  alt=""
                                />
                              </figure>
                            </div>
                        ...
                        <div className="col-xl-6 col-md-6">
                          <div className="inner__box">
                            <div className="image__box">
                              <figure className="image">
                                <img
                                  src="assets/images/news/news-11.png"
                                  alt=""
                                />
                              </figure>
                            </div>
                    ...
                    <div className="normal__text">
                      <p>
                        ...
                        Tortor etiam sed suspendisse faucibus volutpat mattis
                        tortor nec. Orc velit posuere turpis amet lectus lacus
                        lectus habitase amet quam libero lorem. Volutpat lacus
                    ...
                    <div className="left__tag">
                      <div className="sidebar__tag">
                        <ul className="sidebar__tag__box">
                          <li>
                            <Link href="/shop">Designing</Link>
                          </li>
                          <li>
                            <Link href="/shop">Projects</Link>
                          </li>
                          <li>
                            <Link href="/shop">Repair</Link>
                          </li>
                        </ul>
                      </div>
                    </div>
                    <div className="details__authore p_relative">
                      <div
                        className="image_layer shape-57"
                        style={{
                          backgroundImage:
                            "url(assets/images/shape/shape-57.png)",
                        }}
                      ></div>
                      <div className="comment">
                        <figure className="thumb-box">
                          <img
                            src="assets/images/news/news-authore.png"
                            alt=""
                          />
                        </figure>
                        <div className="comment__inner">
                          ...
                          <p>
                            ...
                            elit amet sit purus tempor dui pharetra consequat
                            nibh elit urna interdum viera quam habitase amet
                            quam libero lorem lacus maecenas.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="single__sidebar__box">
                      ...
                      <div className="sidebar__categories">
                        <ul className="sidebar__categories__box">
                          <li>
                            <Link href="/shop">Cleaning Roof</Link>
                          </li>
                          <li>
                            <Link href="/shop">Designing Technology</Link>
                          </li>
                          <li>
                            <Link href="/shop">Renovation Roof</Link>
                          </li>
                          <li>
                            <Link href="/shop">Modern Architecture</Link>
                          </li>
                          <li>
                            <Link href="/shop">Designing</Link>
                          </li>
                          <li>
                            <Link href="/shop">Siding Roof</Link>
                          </li>
                        </ul>
                      </div>
                    </div>
                      ...
                      <div className="sidebar__repost">
                        <div className="post__inner">
                          <div className="post">
                              ...
                              <div className="image__box">
                                <figure className="image">
                                  <Link href="/blog-details">
                                    <img
                                      src="assets/images/news/news-07.png"
                                      alt=""
                                    />
                                  </Link>
                                </figure>
                            ...
                            <h6>
                              <Link href="/blog-details">
                                Get tips to protect your Designings
                              </Link>
                            </h6>
                            ...
                            <div className="inner__box">
                              <div className="image__box">
                                <figure className="image">
                                  <Link href="/blog-details">
                                    <img
                                      src="assets/images/news/news-08.png"
                                      alt=""
                                    />
                                  </Link>
                                </figure>
                          ...
                          <div className="post">
                            <div className="inner__box">
                              <div className="image__box">
                                <figure className="image">
                                  <Link href="/blog-details">
                                    <img
                                      src="assets/images/news/news-09.png"
                                      alt=""
                                    />
                                  </Link>
                                </figure>
                            ...
                            <h6>
                              <Link href="/blog-details">
                                We won best factory award of the ..
                              </Link>
                            </h6>
                            <div className="post__info">
                              <ul className="post-info clearfix">
                    ...
                    <div className="single__sidebar__box">
                      ...
                      <div className="sidebar__tag">
                        <ul className="sidebar__tag__box">
                          ...
                          <li>
                            <Link href="/shop">Architecture</Link>
                          </li>
                          <li>
                            <Link href="/shop">Maintainance</Link>
                          </li>
                          <li>
                            <Link href="/shop">Designing</Link>
                          </li>
                          <li>
                            <Link href="/shop">Quality</Link>
                          </li>
                          <li>
                            <Link href="/shop">Material</Link>
                          </li>
                        </ul>
                      </div>
                    </div>
