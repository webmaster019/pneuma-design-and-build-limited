                ...
                <div className="col-lg-4 col-md-6 col-sm-12 pe-lg-0">
                  <div className="image__section">
                    <figure className="image">
                      <img
                        src="assets/images/team/team-details-01.png"
                        alt=""
                      />
                    </figure>
                  </div>
                  ...
                  <div className="team__right__content">
                    ...
                    <div className="normal__text">
                      <p>
                        ...
                        Commodo sem diam et, sollicitudin eget. Tellus velit
                        etiam elit, mi pretium eu. Suspendisse imperdiet enim
                        ornare elit, eu vestibulum enim imperdiet viverra.
                        Elementum habitant non mi est nec nunc. Orci odio
                        dignissim aliquam dapibus duis. Faucibus velit amet
                        vitae sed orc.
                      </p>
                    </div>
                    ...
                    <div className="skill__list">
                      <ul>
                        <li>
                          <span>Expertise:</span> Designing, Leadership
                        </li>
                        <li>
                          <span>Experience:</span> 08 Years
                        </li>
                        <li>
                          <span>Email:</span>{" "}
                          <a href="mailto:brooklyn@gmail.com">
                            brooklyn@gmail.com
                          </a>{" "}
                        </li>
                        <li>
                          <span>Phone:</span>{" "}
                          <a href="tel:3336660021">(+91) 333 666 0021</a>
                        </li>
                      </ul>
                    </div>
                  </div>
            ...
            <div className="auto_container">
              ...
              <div className="normal__text">
                <p>
                  ...
                  et enim justo, in mauris posuere dolor. Dolor felis sapien sit
                  ...
                  feugiat laoreet potenti integer. Viverra at maecenas convallis
                ...
                <p>
                  ...
                  tempus. Massa sed sit faucibus neque ac. Nibh nisl nisl id
                  fermentum habitant consequat. A ornare in dis sit cras natoque
                  morbi. Phasellus senectus tortor sed magnis. Egestas nunc
                  pellentesque egestas gravida amet.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="skil__content">
                <div className="normal__text">
                  <p>
                    ...
                    egestas amet feugiat laoreet potenti integer. Viverra at
                  ...
                  <div className="row">
                    <div className="col-lg-6 pe-lg-5">
                      <div className="skill__progressbar">
                        ...
                        <div className="progressbar__outer">
                          <div
                            className="progressbar__inner1 progress__line"
                            data-width="75"
                          ></div>
                      ...
                      <div className="skill__progressbar">
                        ...
                        <div className="progressbar__outer">
                          <div
                            className="progressbar__inner2 progress__line"
                            data-width="90"
                          ></div>
                          <div className="progressbar__percentage">
                            <div className="count-box">
                    ...
                    <div className="col-lg-6 pe-lg-5">
                      <div className="skill__progressbar">
                        ...
                        <div className="progressbar__outer">
                          <div
                            className="progressbar__inner3 progress__line"
                            data-width="80"
                          ></div>
                          <div className="progressbar__percentage">
                            <div className="count-box">
                      ...
                      <div className="skill__progressbar">
                        ...
                        <div className="progressbar__outer">
                          <div
                            className="progressbar__inner4 progress__line"
                            data-width="70"
                          ></div>
                          <div className="progressbar__percentage">
                            <div className="count-box">
