                    ...
                    <div className="single-sidebar-box style2">
                      ...
                      <div className="sidebar-categories">
                        <ul className="sidebar-categories-box">
                          ...
                          <li>
                            <Link href="/shop">Drill Machine</Link>
                          </li>
                          <li>
                            <Link href="/shop">Helmet</Link>
                          </li>
                          <li>
                            <Link href="/shop">Gloves Wall</Link>
                          </li>
                          <li>
                            <Link href="/shop">Accessories</Link>
                          </li>
                          <li>
                            <Link href="/shop">Uncategories</Link>
                          </li>
                        </ul>
                      </div>
                    </div>
